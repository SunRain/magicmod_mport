...
public abstract interface MiuiActionBar {
    public abstract int addFragmentTab(String tag, ActionBar.Tab tab, int index,
            Class<? extends Fragment> fragment, Bundle args, boolean hasActionMenu);

    public abstract int addFragmentTab(String paramString, ActionBar.Tab paramTab,
            Class<? extends Fragment> paramClass, Bundle paramBundle, boolean paramBoolean);

    public abstract void addOnFragmentViewPagerChangeListener(
            FragmentViewPagerChangeListener paramFragmentViewPagerChangeListener);

    public abstract void addOnMenuVisibilityListener(
            ActionBar.OnMenuVisibilityListener paramOnMenuVisibilityListener);
    ...
    public abstract void removeFragmentTab(String tag);

    public abstract void removeFragmentTabAt(int position);

    public abstract void removeOnFragmentViewPagerChangeListener(
    ...
    public abstract void setFragmentActionMenuAt(int position, boolean hasActionMenu);

    public abstract void setFragmentViewPagerMode(Context paramContext,
    ...
    public abstract void setListNavigationCallbacks(SpinnerAdapter paramSpinnerAdapter,
            ActionBar.OnNavigationListener paramOnNavigationListener);
    ...
    public abstract void setViewPagerOffscreenPageLimit(int limit);
    ...
    public static abstract interface FragmentViewPagerChangeListener {
        ...
        public abstract void onPageScrolled(int position, float positionOffset,
                boolean fromHasActionMenu, boolean toHasActionMenu);
